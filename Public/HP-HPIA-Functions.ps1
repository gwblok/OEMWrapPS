...
Source: https://github.com/gwblok/garytown/blob/master/hardware/HP/EMPS/Test-HPIASupport.ps1

Functions for HP Image Assistant (HPIA) platform support, OS support queries, SoftPaq listing, and driver pack retrieval.
#>
